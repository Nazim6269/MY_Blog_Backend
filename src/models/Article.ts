...
class ArticleClass {
  ...
  #sortAsc(articles: Article[], sortBy: string) {
  ...
  //======this is sorting helper function==========//
  #sortDsc(articles: Article[], sortBy: string) {
    return articles.sort((a, b) =>
  ...
  //======= pagination function============//
  pagination(articles: Article[], page: number, limit: number) {
